...
//		"ostin-m" => array("Остин-М", "Ширина: 60 см<br>Высота: 84 см<br>Глубина: 50 см<br>Высота сидения: 45 см", "ольха", "гнутоклееные детали из шпона, металлические полозья", 6500, 1),
		...
		"medal" => array("Медальон", "Ширина: 51 см<br>Высота: 96 см<br>Глубина: 45 см<br>Высота сидения: 45 см", "белый + золотая патина", "массив бука", 9000, 1),
		...
		"markiz" => array("Маркиз", "Ширина: 48 см<br>Высота: 91 см<br>Глубина: 58 см<br>Высота сидения: 45 см", "белый + золотая патина", "ABS-пластик (передние ноги), массив березы", 8200),
